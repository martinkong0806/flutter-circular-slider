...
class _SleepPageState extends State<SleepPage> {
  ...
  DoubleCircularSlider slide1() {
    return DoubleCircularSlider(
            ...
            handlerColor: Colors.white,
            handlerOutterRadius: 12.0,
            onSelectionChange: (a,b,c)=>print('slider1'),
  ...
  DoubleCircularSlider slide2() {
    return DoubleCircularSlider(
      ...
      primarySectors: 6,
      secondarySectors: 24,
      baseColor: Color.fromRGBO(255, 0, 0, 0),
      selectionColor: baseColor,
      handlerColor: Colors.red,
      handlerOutterRadius: 12.0,
      onSelectionChange: (a, b, c) => print('slider2'),
      // onSelectionEnd: (a, b, c) => print('onSelectionEnd $a $b $c'),
      sliderStrokeWidth: 12.0,
      child: Container()
